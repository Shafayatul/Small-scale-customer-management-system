            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col-auto">
                      <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">${{ $recurring_invoice }}</div>
                    </div>
                    <div class="col">
        ...
        <div class="col-xl-12 col-lg-12">
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
              <h6 class="m-0 font-weight-bold text-primary">Paid Invoice last 30 days</h6>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="{{ url('/customers/create') }}" class="btn btn-success btn-sm" title="Add New Role">
                            ...
                            @foreach($customers as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('/customer-invoice/' . $item->id) }}" title="View Role"><button class="btn btn-success btn-sm"><i class="fas fa-file-invoice" aria-hidden="true"></i> Invoice</button></a>
...
var graphLabels = [];
var graphDate   = [];
@foreach($paid_invoice_per_day as $key => $val)
